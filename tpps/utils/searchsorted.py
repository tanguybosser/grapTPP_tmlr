...
#from th.searchsorted import searchsorted as ss
#import torch.searchsorted as ss 

from typing import Optional


def searchsorted(
        a: th.Tensor, v: th.Tensor, mask: Optional[th.Tensor] = None): #a are append with the beginning of the window and v are append with the end of the window
    """
        Args:
