...
def get_command(dataset, save_dir, batch_size, split, config_num, args, eval_metrics, config, save_check_dir):
    if args.encoder in ['gru', 'constant'] and args.decoder == 'conditional-poisson':
        ...
        cmd = "python3 -u scripts/train.py --no-mlflow --dataset={} --load-from-dir={} --save-results-dir={} --save-check-dir={} " \
