...
from tpps.models.encoders.base.fixed_history import FixedHistoryEncoder

from tpps.pytorch.models import MLP

from tpps.utils.events import Events
from tpps.utils.transformer_utils import TransformerEncoderNetwork
from tpps.utils.transformer_utils import TransformerEncoderLayer
from tpps.utils.transformer_utils import generate_square_subsequent_mask_fixed


class SelfAttentionFixedEncoder(FixedHistoryEncoder):
    ...
    def __init__(
            ...
            **kwargs):
        super(SelfAttentionFixedEncoder, self).__init__(
            name="selfattention-fixed",
    ...
    def forward(self, events: Events) -> Tuple[th.Tensor, th.Tensor, Dict]:
        ...
        if (self.src_mask is None
            ...
            src_mask = generate_square_subsequent_mask_fixed(
                sz=histories.size()[1],
