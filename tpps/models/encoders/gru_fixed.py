...
from tpps.models.encoders.base.recurrent_fixed import RecurrentFixedEncoder
from tpps.pytorch.models import MLP

from tpps.utils.encoding import encoding_size
from tpps.utils.events import Events

class GRUFixedEncoder(RecurrentFixedEncoder):
    ...
    def __init__(
        ...
        super(GRUFixedEncoder, self).__init__(
            name="gru-fixed",
            rnn = gru, 
            units_mlp=units_mlp,
