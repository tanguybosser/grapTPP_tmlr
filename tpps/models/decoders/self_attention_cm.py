...
from tpps.utils.transformer_utils import TransformerDecoderNetwork
from tpps.utils.transformer_utils import TransformerDecoderLayer
...
class SelfAttentionCmDecoder(CumulativeDecoder):
    ...
    def cum_intensity(
        ...
        memory_mask = memory_mask.masked_fill(items_to_neg_inf, float('-inf')) #Put past events to 0 and future events to -inf ? 
